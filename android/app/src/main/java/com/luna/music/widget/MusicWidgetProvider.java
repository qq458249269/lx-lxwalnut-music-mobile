...
public class MusicWidgetProvider extends AppWidgetProvider {
    ...
    public static final String ACTION_PLAY_PAUSE = "com.luna.music.widget.PLAY_PAUSE";
    public static final String ACTION_PREV = "com.luna.music.widget.PREV";
    public static final String ACTION_NEXT = "com.luna.music.widget.NEXT";
    public static final String ACTION_UPDATE_WIDGET = "com.luna.music.widget.UPDATE";

    // Internal actions to forward to JS to avoid loop
    public static final String INTERNAL_ACTION_PLAY_PAUSE = "com.luna.music.widget.INTERNAL_PLAY_PAUSE";
    public static final String INTERNAL_ACTION_PREV = "com.luna.music.widget.INTERNAL_PREV";
    public static final String INTERNAL_ACTION_NEXT = "com.luna.music.widget.INTERNAL_NEXT";
